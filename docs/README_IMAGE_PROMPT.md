...
- 右側：インストール手順／システム要件／技術スタック／ライセンス／注意書き
  （それぞれ README_IMAGE_SPEC.md の Notes・Technology・License の内容を反映する）

## トーン・スタイル
- 手描き風のポップなインフォグラフィック。フラットデザインだが線に手描きの揺らぎを持たせる
- 各セクションは太めの角丸ボーダー付きボックスで区切り、ボックスごとに異なるパステルカラー
  （青・緑・黄・ピンク・紫など）を使う
- 星・キラキラ・リボン帯・吹き出しなどの手描き風装飾を要所に散りばめる
- 背景はオフホワイト〜クリーム色
- テキストはすべて日本語（見出し・本文とも）。フォントは丸みのあるゴシック体
