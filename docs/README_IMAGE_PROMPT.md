...
## 絶対に守ること
- 左上に配置するロゴのアイコン部分は、以下のURLの画像をそのまま使用すること：
  https://raw.githubusercontent.com/hidecode365/win-launcher/main/src-tauri/icons/32x32.png
  このアイコン画像を、独自にデザインし直したり別のアイコンに置き換えたりせず、指定した位置
  （左上、アプリ名「WinLauncher」のロゴタイプの左隣）にそのまま配置すること。
