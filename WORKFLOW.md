...
- CA INPUT: POの要求（自然文）、現状の `REQUIREMENTS.md`
- CC INPUT: CA からの事前調査照会、または解釈確認依頼。いずれも現状の `REQUIREMENTS.md`
- PROCESS: 1. 要求を言語化する 2. 事前調査（既存設計・実装への影響を確認し、必要なら CC へ実装コスト観点で照会する） 3. 要件を確定し `REQUIREMENTS.md` へ反映する（CC へ更新指示。CC の解釈確認を経て CC が編集する）
